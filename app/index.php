    ...
    <div class="main-wrapper top-bar-open display-as-tiles loading" id="main-wrapper-div">
            ...
            <div id="window-side-div" class="window-side">
                ...
                <div class="side-box">
                    <div class="side-category">
                        <button class="side-category-label bright-hover"
                            onclick="this.parentNode.classList.toggle('side-category-open')">Account Settings <div
                                class="arrow-icon arrow-icon-generate side-category-label-arrow"></div></button>
                        <div class="side-category-content">
                            <form class="side-form" id="form-userchange" method="PUT" data-submit-label="USERCHANGE">
                                <input class="text-box" type="text" data-validate="label" id="fullname" name="fullname" value="Jiří Humpl"
                                    placeholder="Full Name">
                                <input class="text-box" type="text" data-validate="username" id="nick" name="nickname" value="humpljir"
                                ...
                                <div class="side-form-buttons"><input type="reset"
                                        onclick="this.closest('.side-form').classList.remove('form-changed')"
                                        value="RESET"><input type="submit" class="side-form-submit" value="SAVE"></div>
                            </form>
                        </div>
                    </div>
                    <div class="side-category">
                        <button class="side-category-label bright-hover"
                            onclick="this.parentNode.classList.toggle('side-category-open')">Change Password <div
                                class="arrow-icon arrow-icon-generate side-category-label-arrow"></div></button>
                        <div class="side-category-content">
                            <form class="side-form" id="form-changepass" method="PUT" data-submit-label="CHANGEPASS">
                                <input class="text-box" type="password" data-validate="password" id="change-password" name="password"
                                    placeholder="new password">
                                <input class="text-box" type="password" data-validate="match" data-validate-match-id="change-password" id="change-password-check" name="password-check"
                    ...
                    <div class="side-category">
                        <button class="side-category-label bright-hover"
                            onclick="this.parentNode.classList.toggle('side-category-open')">Appearance & Colors <div
                                class="arrow-icon arrow-icon-generate side-category-label-arrow"></div></button>
                        <div class="side-category-content">
                            <form class="side-form" id="form-appearence" method="PUT" data-submit-label="CREATE">
                                <label class="side-form-switch-wrapper">
                                    <span class="side-form-switch-label">Turn On Dark Theme</span><input
                                        onclick="toggleDarkTheme()" type="checkbox" class="side-form-switch">
                                </label>
                                <label class="side-form-switch-wrapper">
                                    <span class="side-form-switch-label">Auto Resize Top Bar</span><input
                                        type="checkbox" checked
                                        onchange="switchSessionVal('topbarAutoHeight',this.checked)"
                                        class="side-form-switch">
                                </label>
                                ...
                                <div class="side-theme-selector">
                                    <label>
                                        <input type="radio" id="theme-0" name="palette" data-palette-nr=0
                                            onclick="changePalette(this.getAttribute('data-palette-nr'))">
                                        <div
                                            style="--inner-color: #AB5530;--theme-palette:#6D4E62 0%, #6D4E62 20%, #8C9496 20%, #8C9496 40%,#40433F 40%, #40433F 60%,#537E49 60%, #537E49 80%,#1E1800 80%, #1E1800 100%;">
                                        </div>
                                    </label> <label>
                                        <input type="radio" id="theme-1" name="palette" checked data-palette-nr=1
                                            onclick="changePalette(this.getAttribute('data-palette-nr'))">
                                        <div
                                            style="--inner-color: #E63946;--theme-palette:#457B9D 0%, #457B9D 20%, #1D3557 20%, #1D3557 40%,#A8DADC 40%, #A8DADC 60%,#F1FAEE 60%, #F1FAEE 80%,#8b2c33 80%, #8b2c33 100%;">
                                        </div>
                                    </label> <label>
                                        <input type="radio" id="theme-2" name="palette" data-palette-nr=2
                                            onclick="changePalette(this.getAttribute('data-palette-nr'))">
                                        <div
                                            style="--inner-color: #AB5530;--theme-palette:#6D4E62 0%, #6D4E62 20%, #8C9496 20%, #8C9496 40%,#40433F 40%, #40433F 60%,#537E49 60%, #537E49 80%,#1E1800 80%, #1E1800 100%;">
                                        </div>
                                    </label> <label>
                                        <input type="radio" id="theme-3" name="palette" data-palette-nr=3
                                            onclick="changePalette(this.getAttribute('data-palette-nr'))">
                                        <div
                                            style="--inner-color: #AB5530;--theme-palette:#6D4E62 0%, #6D4E62 20%, #8C9496 20%, #8C9496 40%,#40433F 40%, #40433F 60%,#537E49 60%, #537E49 80%,#1E1800 80%, #1E1800 100%;">
                                        </div>
                                    </label> <label>
                                        <input type="radio" id="theme-4" name="palette" data-palette-nr=4
                                            onclick="changePalette(this.getAttribute('data-palette-nr'))">
                                        <div
                                            style="--inner-color: #AB5530;--theme-palette:#6D4E62 0%, #6D4E62 20%, #8C9496 20%, #8C9496 40%,#40433F 40%, #40433F 60%,#537E49 60%, #537E49 80%,#1E1800 80%, #1E1800 100%;">
                                        </div>
                                    </label> <label>
                                        <input type="radio" id="theme-5" name="palette" data-palette-nr=5
                                            onclick="changePalette(this.getAttribute('data-palette-nr'))">
                                        <div
                                            style="--inner-color: #AB5530;--theme-palette:#6D4E62 0%, #6D4E62 20%, #8C9496 20%, #8C9496 40%,#40433F 40%, #40433F 60%,#537E49 60%, #537E49 80%,#1E1800 80%, #1E1800 100%;">
                                        </div>
                                    </label><label>
                                        <input type="radio" id="theme-6" name="palette" data-palette-nr=6
                                            onclick="changePalette(this.getAttribute('data-palette-nr'))">
                                        <div
                                            style="--inner-color: #AB5530;--theme-palette:#6D4E62 0%, #6D4E62 20%, #8C9496 20%, #8C9496 40%,#40433F 40%, #40433F 60%,#537E49 60%, #537E49 80%,#1E1800 80%, #1E1800 100%;">
                                        </div>
                                    </label> <label>
                                        <input type="radio" id="theme-7" name="palette" data-palette-nr=7
                                            onclick="changePalette(this.getAttribute('data-palette-nr'))">
                                        <div
                                            style="--inner-color: #AB5530;--theme-palette:#6D4E62 0%, #6D4E62 20%, #8C9496 20%, #8C9496 40%,#40433F 40%, #40433F 60%,#537E49 60%, #537E49 80%,#1E1800 80%, #1E1800 100%;">
                                        </div>
                                    </label> <label>
                                        <input type="radio" id="theme-8" name="palette" data-palette-nr=8
                                            onclick="changePalette(this.getAttribute('data-palette-nr'))">
                                        <div
                                            style="--inner-color: #AB5530;--theme-palette:#6D4E62 0%, #6D4E62 20%, #8C9496 20%, #8C9496 40%,#40433F 40%, #40433F 60%,#537E49 60%, #537E49 80%,#1E1800 80%, #1E1800 100%;">
                                        </div>
                                ...
                                <div class="side-color-palette"><label
                                        onclick="changeHighlightColor('var(--theme-color-0)','var(--theme-color-0-complementary)')"><input
                                            type="radio" id="blabla0" name="color">
                                        <div style="--circle-color:var(--theme-color-0);"></div>
                                    </label><label
                                        onclick="changeHighlightColor('var(--theme-color-1)','var(--theme-color-1-complementary)')"><input
                                            type="radio" id="blabla1" name="color">
                                        <div style="--circle-color:var(--theme-color-1);"></div>
                                    </label><label
                                        onclick="changeHighlightColor('var(--theme-color-2)','var(--theme-color-2-complementary)')"><input
                                            type="radio" id="blabla2" name="color">
                                        <div style="--circle-color:var(--theme-color-2);"></div>
                                    </label><label
                                        onclick="changeHighlightColor('var(--theme-color-3)','var(--theme-color-3-complementary)')"><input
                                            type="radio" checked id="blabla3" name="color">
                                        <div style="--circle-color:var(--theme-color-3);"></div>
                                    </label><label
                                        onclick="changeHighlightColor('var(--theme-color-4)','var(--theme-color-4-complementary)')"><input
                                            type="radio" id="blabla4" name="color">
                                        <div style="--circle-color:var(--theme-color-4);"></div>
                                    </label><label
                                        onclick="changeHighlightColor('var(--theme-color-5)','var(--theme-color-5-complementary)')"><input
                                            type="radio" id="blabla5" name="color">
                                        <div style="--circle-color:var(--theme-color-5);"></div>
                                    </label><label
                                        onclick="changeHighlightColor('var(--theme-color-6)','var(--theme-color-6-complementary)')"><input
                                            type="radio" id="blabla6" name="color">
                                        <div style="--circle-color:var(--theme-color-6);"></div>
                                    </label><label
                                        onclick="changeHighlightColor('var(--theme-color-7)','var(--theme-color-7-complementary)')"><input
                                            type="radio" id="blabla7" name="color">
                                        <div style="--circle-color:var(--theme-color-7);"></div>
                                    </label><label
                                        onclick="changeHighlightColor('var(--theme-color-8)','var(--theme-color-8-complementary)')"><input
                                            type="radio" id="blabla8" name="color">
                                        <div style="--circle-color:var(--theme-color-8);"></div>
                                    </label><label
                                        onclick="changeHighlightColor('var(--theme-color-9)','var(--theme-color-9-complementary)')"><input
                                            type="radio" id="blabla9" name="color">
                                        <div style="--circle-color:var(--theme-color-9);"></div>
                                    </label><label
                                        onclick="changeHighlightColor('var(--theme-color-10)','var(--theme-color-10-complementary)')"><input
                                            type="radio" id="blabla10" name="color">
                                        <div style="--circle-color:var(--theme-color-10);"></div>
                                    </label><label
                                        onclick="changeHighlightColor('var(--theme-color-11)','var(--theme-color-11-complementary)')"><input
                                            type="radio" id="blabla11" name="color">
                    ...
                    <div class="side-category">
                        <button class="side-category-label bright-hover"
                            onclick="this.parentNode.classList.toggle('side-category-open')">Custom Toolbar <div
                                class="arrow-icon arrow-icon-generate side-category-label-arrow"></div></button>

                        <div class="side-category-content">
                            <form class="side-form" id="form-toolbar-edit" method="PUT" data-submit-label="USERCHANGE">
                                <label class="side-form-switch-wrapper">
                                    <span class="side-form-switch-label">Enable Toolbar</span><input type="checkbox"
                                        onchange="switchSessionVal('toolbarVisible',this.checked)" checked
                                        class="side-form-switch">
                                </label>
                                <label class="side-form-switch-wrapper">
                                    <span class="side-form-switch-label">Auto Hide Toolbar</span><input
                                        type="checkbox" checked
                                        onchange="switchSessionVal('toolbarAutoHeight',this.checked)"
                                        class="side-form-switch">
                                </label>
                                <label class="side-form-switch-wrapper">
                                    <span class="side-form-switch-label">Advanced Customization</span><input
                                        onchange="toggleToolbarEditMode()" type="checkbox" class="side-form-switch">
                                </label>
                                <div class="side-form-title-div">
                    ...
                    <div class="side-category">
                        <button class="side-category-label bright-hover"
                            onclick="this.parentNode.classList.toggle('side-category-open')">Notifications <div
                                class="arrow-icon arrow-icon-generate side-category-label-arrow"></div></button>
                        <div class="side-category-content">
                            <form class="side-form" id="form-notifications" method="PUT" data-submit-label="USERCHANGE"><label
                                    class="side-form-switch-wrapper">
                                    <span class="side-form-switch-label">Turn On PWA Notifications</span><input
                                        type="checkbox" class="side-form-switch"
                                        onchange="sideNotifications(this.checked)">
                                </label>
                                <div class="side-form-buttons"><input type="reset"
                                        onclick="this.closest('.side-form').classList.remove('form-changed')"
                                        value="RESET"><input type="submit" class="side-form-submit" value="SAVE"></div>
                    ...
                    <div class="side-category">
                        <button class="side-category-label bright-hover"
                            onclick="this.parentNode.classList.toggle('side-category-open')">Storage <div
                                class="arrow-icon arrow-icon-generate side-category-label-arrow"></div></button>
                        <div class="side-category-content">
                ...
                <div class="side-box">
                    <div class="side-category">
                        <button class="side-category-label bright-hover"
                            onclick="this.parentNode.classList.toggle('side-category-open')">Log Out</button>
                    ...
                    <div class="side-category">
                        <button class="side-category-label bright-hover"
                            onclick="this.parentNode.classList.toggle('side-category-open')">Help & Feedback <div
                                class="arrow-icon arrow-icon-generate side-category-label-arrow"></div></button>
                        <div class="side-category-content">
                ...
                <div class="side-box">
                    <div class="side-category">
                        <button class="side-category-label bright-hover"
                            onclick="this.parentNode.classList.toggle('side-category-open')">About <div
                                class="arrow-icon arrow-icon-generate side-category-label-arrow"></div></button>
                        <div class="side-category-content">
        ...
        <div class="menu-wrapper" id="menu-wrapper-div">
            <div class="menu-formbox fluent-bg" id="menu-formbox-div">
                ...
                <form class="" id="form-2" method="POST" data-submit-label="CREATE">
